            ...
            <div className="relative w-full flex flex-col max-w-md md:max-w-4xl mx-auto">
                ...
                <main className="w-full grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="rounded-xl bg-slate-900 overflow-hidden relative p-4 mb-2">
                            <div
                            ...
                            <div className="relative z-10 flex items-center justify-between">
                                <div className="max-w-[70%]">
                                    <h5 className="text-white font-bold text-xs">Obtén 5% de Cashback</h5>
                                    <p className="text-white/70 text-[10px] mt-0.5">En todas tus compras con tu tarjeta CTFIN.</p>
                                </div>
                                <button className="bg-white text-slate-900 px-3 py-1.5 rounded-lg text-[10px] font-bold hover:bg-slate-100 transition-colors">
                                    Activar
                                </button>
                            </div>
                        </div>
